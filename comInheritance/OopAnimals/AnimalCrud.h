...
class ATL_NO_VTABLE CAnimalCrud :
	...
	public IDispatchImpl<IAnimalCrud, &IID_IAnimalCrud, &LIBID_OopAnimalsLib, /*wMajor =*/ 1, /*wMinor =*/ 0>
{
public:
...
END_COM_MAP()
	...
	STDMETHOD(CreateAnimal)(LONG type, IAnimal** animal) noexcept override;
};
